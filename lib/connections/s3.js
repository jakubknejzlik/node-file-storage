...
(function() {
  ...
  S3Connection = (function(superClass) {
    ...
    S3Connection.prototype.saveStream = function(stream, id, callback) {
      return this._saveObject(stream, id, callback);
    };

    S3Connection.prototype.saveData = function(data, id, callback) {
      return this._saveObject(data, id, callback);
    };

    S3Connection.prototype._saveObject = function(object, id, callback) {
      var upload;
