...
(function() {
  var Connection, Grid, MongoDBConnection, mongo, _ref,
  ...
  MongoDBConnection = (function(_super) {
    __extends(MongoDBConnection, _super);

    function MongoDBConnection() {
      _ref = MongoDBConnection.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    MongoDBConnection.prototype.connect = function(callback) {
      ...
      return mongodb.open(function(err) {
        if (err) {
          return callback(err);
        }
